...
export default function Routes({ appProps }) {
    return (
        <Switch>
            ...
            <AppliedRoute path="/Inventory" exact component={Inventory} appProps={appProps} />
            <AppliedRoute path="/Transaction" exact component={Transaction} appProps={appProps} />
            <AppliedRoute path="/TransactionDetails" exact component={TransactionDetails} appProps={appProps} />
            <AppliedRoute path="/Employees" exact component={Employees} appProps={appProps} />
            <AppliedRoute path="/Suppliers" exact component={Suppliers} appProps={appProps} />
